...
const Dashboard = () => {
    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            {/* Welcome message */}
            <div className="gradient-primary text-white rounded-2xl p-6 md:p-8">
                <h1 className="text-2xl md:text-3xl font-bold mb-2">Welcome to PARAGON Admin</h1>
                <p className="text-blue-100">Manage your coaching center from this dashboard.</p>
            </div>
