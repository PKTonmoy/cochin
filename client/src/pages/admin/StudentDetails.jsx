...
import { ArrowLeft, Edit, Phone, Mail, User, Calendar, DollarSign, BookOpen, Download, FileText, CheckCircle, XCircle } from 'lucide-react'
...
const StudentDetails = () => {
    ...
    const handleDownloadReceipt = async (receiptId) => {
        try {
            // Check if we can open it in a new tab first (if it's a URL)
            // But since the API handles redirection or download, we can just open the API endpoint
